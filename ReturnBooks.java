...
conPan.setHorizontalGroup(
    conPan.createParallelGroup(Alignment.TRAILING)
        .addGroup(conPan.createSequentialGroup()
            .addGap(36)
            .addGroup(conPan.createParallelGroup(Alignment.TRAILING, false)
                .addComponent(idLib, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(stuId, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE))
            .addGap(56)
